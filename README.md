...
| GIT_CLONE_REF                   | the git revision (branch, tag or hash) to check out                                                                | "master                  |
...
| GIT_CLONE_USERNAME              | the username to use for git auth                                                                                   | ""                       |
| GIT_CLONE_PASSWORD              | the password to use for git auth (users should prefer env vars for passwords)                                      | ""                       |
